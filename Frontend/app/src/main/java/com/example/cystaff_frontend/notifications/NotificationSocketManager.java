...
public class NotificationSocketManager {
    ...
    private static com.example.cystaff_frontend.notifications.NotificationSocketManager instance;
    private MyWebSocketClient webSocketClient;
    private NotificationSocketListener webSocketListener;
     ...
     */
    public static synchronized com.example.cystaff_frontend.notifications.NotificationSocketManager getInstance() {
        if (instance == null) {
            instance = new com.example.cystaff_frontend.notifications.NotificationSocketManager();
        }
        return instance;
    }
     ...
     */
    public void setWebSocketListener(NotificationSocketListener listener) {
        this.webSocketListener = listener;
    }

    /**
     * Gets the WebSocketListener for this NotificationSocketManager instance.
     *
     * @return a reference to the webSocketListener
     */
    public NotificationSocketListener getWebSocketListener(){
