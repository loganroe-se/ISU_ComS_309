...
public class MessageWebSocketManager {
    ...
    private static MessageWebSocketManager instance;
    private MyWebSocketClient webSocketClient;
    private MessageWebSocketListener webSocketListener;
    private MessagingActivity activity;

    private MessageWebSocketManager() {}
     ...
     */
    public static synchronized MessageWebSocketManager getInstance() {
        if (instance == null) {
            instance = new MessageWebSocketManager();
        }
        return instance;
    }
     ...
     */
    public void setWebSocketListener(MessageWebSocketListener listener) {
     ...
     */
    public void connectWebSocket(MessagingActivity activity, String serverUrl) {
        try {
    ...
    private class MyWebSocketClient extends WebSocketClient {
        ...
        public void onOpen(ServerHandshake handshakedata) {
            if (webSocketListener != null) {
                webSocketListener.onWebSocketOpen(handshakedata, activity);
            }
        }
        ...
        public void onMessage(String message) {
            ...
            if (webSocketListener != null) {
                webSocketListener.onWebSocketMessage(message, activity);
            }
        }
